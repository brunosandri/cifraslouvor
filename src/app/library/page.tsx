...
import { Music2, Loader2, BookOpen } from 'lucide-react'
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              <button
                ...
                className={`text-xs px-2 py-0.5 rounded border transition-colors ${
                  !activeKey ? 'border-amber-500/50 text-amber-400 bg-amber-500/10' : 'border-gray-700 text-gray-500 hover:text-gray-300'
                }`}
              >
                Todos
              </button>
              {keys.map(k => (
                <button
                  ...
                  className={`text-xs px-2 py-0.5 rounded border transition-colors ${
                    activeKey === k ? 'border-amber-500/50 text-amber-400 bg-amber-500/10' : 'border-gray-700 text-gray-500 hover:text-gray-300'
                  }`}
                >
                  {k}
                </button>
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              {tags.map(t => (
                <button
                  ...
                  className={`text-xs px-2 py-0.5 rounded border transition-colors ${
                    activeTag === t ? 'border-amber-500/50 text-amber-400 bg-amber-500/10' : 'border-gray-700 text-gray-500 hover:text-gray-300'
                  }`}
                >
                  {t}
                </button>
